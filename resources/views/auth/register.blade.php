...
<div class="register-main-wrapper">
    <div class="register-animated-bg"></div>
    <div class="register-particles" id="register-particles">
        <div class="register-particle"></div>
        <div class="register-particle"></div>
        <div class="register-particle"></div>
        <div class="register-particle"></div>
    </div>
    ...
    <div class="register-container mt-4 mb-4">
        <div class="register-card">
            <h3>Sign Up</h3>
            <div id="sign-up-messages" class="register-messages"></div>
    ...
    <!-- Toast Container -->
    <div id="register-toast-container" class="register-toast-container"></div>
</div>
@endsection
...
@push('scripts')
    ...
    <script>
        particlesJS('register-particles', {
            particles: {
                number: { value: 4 },
